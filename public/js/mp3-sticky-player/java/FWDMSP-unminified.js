		...
		_s.palylistItemOnUpHandler = function(e){
			...
			if(e.id == _s.id){
				if(_s.audioType_str == FWDMSP.AUDIO && _s.audioScreen_do.isPlaying_bl){
					...
					_s.pause();
				}else if(_s.audioType_str == FWDMSP.YOUTUBE && !_s.ytb_do.isStopped_bl){
					_s.play();
				}
			}else{
